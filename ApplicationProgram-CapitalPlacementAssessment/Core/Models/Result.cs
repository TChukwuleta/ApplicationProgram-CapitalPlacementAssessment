...
namespace ApplicationProgram_CapitalPlacementAssessment.Core.Models
{
    ...
    public class Result
    {
        ...
        internal Result(bool status, string message, object data = default, string exception = null)
        {
            Status = status;
            Message = message;
        ...
        internal Result(bool status, object data = default)
        {
            Status = status;
            Data = data;
        }
        ...
        public static Result Exception<T>(string request, Exception ex)
        {
            ILogger logger = ApplicationLogging.CreateLogger<T>();
            logger.LogCritical("Exception:", request, ex);
            return new Result(false, ex.Message, default, ex?.InnerException?.Message);
